...
scripts/
  ...
  reproduce_table8.py     Ablation of methodological components
  reproduce_table9.py     Significance tests and effect sizes (t-test, Wilcoxon)
...
- **MILP settings:** [solver name and version], relative optimality gap [X]% or a
...
| Valuation noise σ | default [value]; swept 0.05 – 0.25 |
...
All reported wall-clock times were measured on: [CPU model, cores, RAM, OS,
Python version]. Details: `environment/hardware.md`.
...
[MIT / Apache-2.0 — choose before making the repository public.] See `LICENSE`.
